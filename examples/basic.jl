...
@assert isauthorised(third_party, read_database)  "Failed $read_database" # true
@assert isauthorised(third_party, ":keys:create") "Failed :keys:create" # true
@assert !isauthorised(third_party, "admin:database:delete") "Failed admin:database:delete" # false